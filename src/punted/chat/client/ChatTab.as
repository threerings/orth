//
// $Id: ChatTab.as 19627 2010-11-24 16:02:41Z zell $
...
public class ChatTab extends HBox
{
    ...
    public function ChatTab (
        ctx :OrthContext, bar :ChatTabBar, channel :OrthChatChannel, roomName :String = null)
    {
        _ctx = ctx;
        _bar = bar;
        _channel = channel;
...
// ORTH TODO: The ChatTabBar is stuffed into the HeaderBar in Whirled. We don't have a HeaderBar,
// nor do we want a chat tab bar per se. This class is destined for deletion as soon as we know
// a bit more of what we're doing with the chat interface.
//        height = HeaderBar.getHeight(ctx.getWorldClient());
    ...
    public function get channel () :OrthChatChannel
    {
        return _channel;
    }
     ...
     */
    public function setChannel (channel :OrthChatChannel) :void
    {
        _channel = channel;
    ...
    {
        return (_channel != null) ? _channel.type : OrthChatChannel.ROOM_CHANNEL;
    }
    ...
    {
        if (getChannelType() == OrthChatChannel.MEMBER_CHANNEL) {
            return (_channel.ident as OrthName).getId();
        }
        return 0;
    }
    ...
    public function setVisualState (state :int) :void
    {
        ...
        case OrthChatChannel.ROOM_CHANNEL:
            style += "RoomTab";
            break;

        case OrthChatChannel.MEMBER_CHANNEL:
            style += "TellTab";
            break;
        }
    ...
    protected var _channel :OrthChatChannel;
