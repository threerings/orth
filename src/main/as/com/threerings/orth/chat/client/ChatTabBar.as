...
{
    public function ChatTabBar (ctx :OrthContext)
    {
        super();
        _ctx = ctx;
    ...
    public function setPlaceName (name :Name) :void
    {
        ...
        _tabs[roomTabIx].setChannel(OrthChatChannel.makeRoomChannel(RoomName(name)));
    ...
    public function memberObjectUpdated (obj :PlayerObject) :void
    {
    ...
    {
        if (event.getName() == PlayerObject.FRIENDS) {
     ...
     */
    public function openChannelTab (channel :OrthChatChannel, fromUserAction :Boolean) :void
    {
    ...
    public function containsTab (channel :OrthChatChannel) :Boolean
    {
    ...
    public function displayMessage (msg :ChatMessage) :void
    {
        ...
        if (OrthChatChannel.typeOf(umsg.localtype) == OrthChatChannel.MEMBER_CHANNEL) {
            var member :OrthName = umsg.getSpeakerDisplayName() as OrthName;
            addTab(new ChatTab(_ctx, this, OrthChatChannel.makeMemberChannel(member), "" + member));
    ...
    protected function createPlaceTab () :void
    {
        ...
        addTab(new ChatTab(_ctx, this, OrthChatChannel.makeRoomChannel(name), ""+name), 0);
        selectedIndex = 0;
    }
